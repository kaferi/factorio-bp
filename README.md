...
- `src/icons.js` — looks up Factorio icon URLs by tag type and renders
  labels with inline `<img>` elements.
- `src/icons-manifest.js` — auto-generated by `scripts/build-icons-manifest.mjs`;
  maps `category_name` keys to jsDelivr URLs.
