...
const messages = {
  en: {
    ...
    'editor.delete.title': 'Delete entity?',
    'editor.delete.bodyOne': 'Delete {name} #{num}? Wires and schedules referencing it will be cleaned up.',
    'editor.delete.bodyMany': 'Delete all {name} ({count} entities)? Wires and schedules referencing them will be cleaned up.',
  ...
  ru: {
    ...
    'editor.delete.title': 'Удалить объект?',
    'editor.delete.bodyOne': 'Удалить {name} #{num}? Связанные провода и расписания поездов будут вычищены.',
    'editor.delete.bodyMany': 'Удалить все объекты «{name}» ({count} шт.)? Связанные провода и расписания будут вычищены.',
